 ...
 * It mimics the behaviour of a swing JDialog which means once a object of this class
 ...
 * pane through the inherited {@link setDialogPane(DialogPane)} methode in the constructor.
...
public class FXAlert extends Alert {
    ...
    private void setLocationRelativeToMainWindow() {
        double mainWindowX = JabRef.jrf.getLocationOnScreen().getX();
        double mainWindowY = JabRef.jrf.getLocationOnScreen().getY();
        double mainWindowWidth = JabRef.jrf.getSize().getWidth();
        double mainWindowHeight = JabRef.jrf.getSize().getHeight();
